...
# Create the development services file.
cat > ${DOMAIN}.localhost/docker/web/settings.local.php <<EOF
<?php
 ...
 * @endcode
 */
\$settings['hash_salt'] = '8fZ3zJAxGG9hK3pja-uioX1Yo4xEvYmM15hofThyDftbFk7eyd0jtLyR0nRNcqUtuwdio91L0A';
